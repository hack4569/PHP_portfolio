...
<script type="text/javascript" src="/webpack.min.js"></script>
...
@section('content')
<div class="layout1"><a href="/wine/adm/product_management/add" class="btn_add">제품 추가</a></div>
			<div class="product_list_cate">
				<form name="rForm" id="rForm" method="get" action="">				
					...
					<div class="product_list_keyword">
						...
						<input type="text" name="skey" value="" class="skey">
						<div class="skey_submit" id="skey_submit">
							<img src="../../images/Search.png" alt="">
						</div>
					</div>
				</form>
				<form action="/wine/adm/product_management/delete" name="delForm" id="delForm" method="post">
						...
						<tbody>
								...
								@else
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left:30px">{{$var['product_code']}}</td>
                                        <td>{{$var['initial_stock']}} - {{$var['quantity']}}</td>
                                        <td>{{$var['in_price']}}</td>
                                        <td>{{$var['out_price']}}</td>
                                        <td>
                                            <a href="" name="btn_modify"  class="btn_modify" id="btn_modify">수정</a>
                                        </td>
                                    </tr>
                                    @endforeach
								@endif
