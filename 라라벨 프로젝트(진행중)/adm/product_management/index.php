...
ini_set("display_errors", 1);
    ...
    //로그인 검증
    $login = new \Login\Authentication("userid", 'manager', $_SESSION['userid']);
    ...
    $route = isset($_GET['route']) ? trim($_GET['route']) : "product_list";
    ...
    $controller = new \Product_management\Product_managementContoller($product_info, $searchVO);
    ...
    include "./views/layout.product_management.php";
