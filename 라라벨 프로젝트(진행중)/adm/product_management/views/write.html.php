<form id="rForm" name="rForm" action="./index.php?route=product_insert&<?=$addUrl?>" method="post" enctype="multipart/form-data">
...
<div class="btn_wrap rg_btn_wrap">
	<a style='display:inline-block; margin-right:10px' class="reg_btn img_upload" href="./index.php?route=product_list&<?=$addUrl?>">목록</a>
</div>
</form>
