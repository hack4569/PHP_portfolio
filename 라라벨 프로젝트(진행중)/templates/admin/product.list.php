...
<div class="layout1"><a href="/wine/adm/product_management/add?<?=$addUrl?>" class="btn_add">제품 추가</a></div>
					...
					<table summary="진행현황목록표" class="table_list">
						...
						<tbody>
								...
								<tr>
									...
									<td>
										<a href="/wine/adm/product_management/update?product_code=<?php echo urlencode($list['product_code']);?>&<?=$addUrl?>" name="btn_modify"  class="btn_modify" id="btn_modify">수정</a>
									</td>
								</tr>
								<?php 
										$listcnt--;
